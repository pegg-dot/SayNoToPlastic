...
const description = "Community resources, practical ways to participate, and the upcoming Field Notes newsletter from Say No to Plastic.";
...
export default function CommunityPage() {
  return <><Header/><main id="main-content" tabIndex={-1} className="inner-page community-v15 community-v16 community-v25 community-v27">
    <section className="community-hero"><picture className="community-visual" aria-hidden="true"><source media="(max-width: 767px)" srcSet="/generations-full-mobile.webp"/><img src="/generations-full.webp" width="1024" height="1536" loading="eager" fetchPriority="high" alt=""/></picture><div><p className="eyebrow">Say No To Plastic</p><h1>For the generations ahead.</h1><p>Join a community learning what new research found, which everyday plastic exposures can be reduced, and how to share practical changes with others.</p><div className="community-newsletter-coming-soon-v2"><p className="eyebrow">Field Notes / Newsletter</p><strong>Coming soon.</strong><p>Research summaries, practical guides, book news, and project updates will be available by email once the mailing platform is connected.</p><small>No email addresses are being collected at launch.</small></div></div></section>
