...
import { getEffectiveTedxEntry, getPublicOwnerNotice } from "../lib/publication-overrides";
...
export default async function MediaPage() {
  const [tedx, ownerUpdate] = await Promise.all([
    getEffectiveTedxEntry(),
    getPublicOwnerNotice("media.owner_update"),
  ]);
