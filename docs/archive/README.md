...
This directory preserves release-specific QA and development records from the iterative build of Say No to Plastic.

These files remain in version control for traceability. They are historical engineering records, not the primary documentation for running or understanding the current application.
