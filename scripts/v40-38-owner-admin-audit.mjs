...
const adminApi = read("app/api/admin/content/route.ts");
...
expect(auth.includes('"dreliebeyondplastic@gmail.com"') && auth.includes('"pegg@gymfinityapp.com"'), "Application allowlist contains exactly the two approved owner identities.");
