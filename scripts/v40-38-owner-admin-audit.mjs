...
expect((adminPanel.includes("Load this version") || adminPanel.includes("Use this version") || adminPanel.includes(">Use this<")) && (adminPanel.includes("Restore original") || adminPanel.includes("Reset to source default")), "Owner admin exposes safe rollback controls without deleting history.");
